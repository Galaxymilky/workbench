...
<br><P><a href="#" onclick="returnList()" style="cursor: pointer;">返回列表</a></P>
...
<div class="panel panel-default" style="overflow-y:scroll; height:530px">
    <div class="panel-body">
        ...
        <table class="table table-striped table-bordered" cellspacing="0" width="100%">
            <tbody style="border: 1px">
            <tr>
                <td class="c_label" style="width: 30%;">
                    <div>参会人</div>
                </td>
                <td class="c_label" style="width: 30%;">
                    <div>职务</div>
            ...
            <c:forEach items="${meetingReceive.mdInfoList}" var="mdInfo">
            	<tr>
            		<td style="text-align:center">${mdInfo.ppName}</td>
            		<td style="text-align:center">${mdInfo.ppDuty}</td>
            		<td style="text-align:center">${mdInfo.ppPhone}</td>
            	</tr>
            </c:forEach>
