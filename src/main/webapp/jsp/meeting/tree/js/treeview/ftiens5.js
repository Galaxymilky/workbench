...
{ 
  ...
  this.iconImg = 0; 
  this.nodeImg = 0;
  this.iconSrc = ICONPATH + "folder-open.gif";
...
{ 
  ...
  if (USEICONS)
  {
	  if(this.nChildren>0){
		  ...
		  docW = docW + this.linkHTML(false) 
		  docW = docW + "<img id='folderIcon" + this.id + "' name='folderIcon" + this.id + "' src='"+ICONPATH+"leaf.gif' border=0></a>"
	  }
  }
  else
  {
